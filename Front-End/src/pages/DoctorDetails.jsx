...
import { Mail, User, Clock, MapPin, Star, Calendar, ChevronLeft, ChevronRight, CheckCircle, XCircle } from 'lucide-react';
            ...
            <div className="flex flex-col md:flex-row items-center">
              ...
              <div>
                ...
                <div className="flex flex-wrap gap-4 mt-4">
                  ...
                  <p className="flex items-center">
                    <User className="mr-2" size={18} /> {selectedDoctor.gender}
                  </p>
        ...
        >
          ...
          <div className="flex flex-wrap items-center justify-between mb-6">
            <div className="flex items-center space-x-4 mb-4 sm:mb-0">
              <button onClick={() => changeDate(-1)} className="p-2 rounded-full bg-mintL hover:bg-mint transition-colors">
                <ChevronLeft size={24} />
              </button>
          ...
          {filteredAppointments.length > 0 ? (
            ...
            <p className="text-gray-600">No available appointments for the selected date and time.</p>
          )}
        </motion.div>
      </div>
    </motion.div>
